...
namespace FamilyConnext.Controllers
{
    public class MilestonesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MilestoneID,MilestoneName,PointsNeeded,FamilyID")] Milestone milestone)
        {
            if (ModelState.IsValid)
            {
                milestone.FamilyID = User.Identity.GetUserId();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MilestoneID,MilestoneName,PointsNeeded,FamilyID")] Milestone milestone)
        {
            if (ModelState.IsValid)
            {
